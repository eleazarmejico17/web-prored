...
<head>
    ...
    <title>Sistema de Gestión de Pagos de Internet - Administrador</title>
    <!-- Tailwind CSS -->
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="bg-white shadow-xl flex flex-col w-64 fixed md:relative h-screen z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-gray-500 text-sm text-center mt-2">Panel del Administrador</p>
            </div>
            ...
            <div class="p-4 border-t border-gray-200">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3">
                        <h3 id="userName" class="font-medium text-gray-800">Carlos Rodríguez</h3>
                        <p id="userRole" class="text-xs text-gray-500">Administrador</p>
                    </div>
                </div>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-grow p-4 md:p-6 overflow-y-auto">
                <div id="dashboardContent" class="bg-white rounded-xl shadow p-6">
                    <h3 class="text-xl font-bold text-primary mb-4">Bienvenido al Panel de Administración</h3>
                    <p class="text-gray-700 mb-4">Administración completa del sistema de pagos de internet.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div class="bg-primary-light p-5 rounded-lg border-l-4 border-primary">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-bold text-primary">Administración</h4>
                                    <p class="text-gray-600 text-sm">Configuración del sistema</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-secondary-light p-5 rounded-lg border-l-4 border-secondary">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-bold text-secondary">Finanzas</h4>
                                    <p class="text-gray-600 text-sm">Gestión financiera completa</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-primary-light p-5 rounded-lg border-l-4 border-primary">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-bold text-primary">Empleados</h4>
    ...
    <script>
        ...
        function loadPageContent(page) {
            ...
            switch(page) {
                case 'dashboard':
                    contentHTML = `
                        <h3 class="text-2xl font-bold text-primary mb-4">Dashboard del Administrador</h3>
                        <p class="text-gray-700 mb-6">Panel de control para la administración completa del sistema de pagos de internet.</p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-primary-light p-5 rounded-xl border-l-4 border-primary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-bold text-primary text-lg">Ingresos Mensuales</h4>
                                        <p class="text-3xl font-bold mt-2 text-primary">$42,580</p>
                                    </div>
                                    <div class="bg-primary p-4 rounded-lg">
                                        <i class="fas fa-dollar-sign text-white text-2xl"></i>
                                    </div>
                                </div>
                                <p class="text-sm text-gray-600 mt-3">Total ingresos este mes</p>
                            </div>
                            ...
                            <div class="bg-secondary-light p-5 rounded-xl border-l-4 border-secondary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-3xl font-bold mt-2 text-secondary">1,248</p>
                                    </div>
                            ...
                            <div class="bg-primary-light p-5 rounded-xl border-l-4 border-primary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-bold text-primary text-lg">Empleados</h4>
                                        <p class="text-3xl font-bold mt-2 text-primary">24</p>
                                    </div>
                                    <div class="bg-primary p-4 rounded-lg">
                                        <i class="fas fa-user-tie text-white text-2xl"></i>
                                    </div>
                                </div>
                                <p class="text-sm text-gray-600 mt-3">Personal activo en el sistema</p>
                            </div>
                        </div>
                        
                        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-white border border-gray-200 rounded-lg p-5">
                                <h4 class="text-lg font-bold text-primary mb-3">Actividad del Sistema</h4>
                                <ul class="space-y-2">
                                    <li class="flex justify-between">
                                        <span class="text-gray-700">Pagos hoy:</span>
                                        <span class="font-bold text-primary">142</span>
                                    </li>
                                    <li class="flex justify-between">
                                        <span class="text-gray-700">Nuevos clientes:</span>
                                        <span class="font-bold text-primary">18</span>
                                    </li>
                                    <li class="flex justify-between">
                                        <span class="text-gray-700">Tickets de soporte:</span>
                            ...
                            <div class="bg-white border border-gray-200 rounded-lg p-5">
                                <h4 class="text-lg font-bold text-primary mb-3">Alertas del Sistema</h4>
                                <div class="space-y-2">
                                    <div class="flex items-center text-yellow-600">
                                        <i class="fas fa-exclamation-triangle mr-2"></i>
                                        <span>1 intento de acceso no autorizado</span>
                                    </div>
                                    ...
                                    <div class="flex items-center text-blue-600">
                                        ...
                                        <span>3 actualizaciones pendientes</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    contentHTML = `
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <ul class="list-disc pl-5 text-gray-700 space-y-2">
                                ...
                                <li>Auditoría y seguridad del sistema</li>
                            </ul>
                        </div>
                    `;
            }
