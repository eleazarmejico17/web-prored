...
<head>
    ...
    <title>Sistema de Gestión de Pagos de Internet - Cliente</title>
    <!-- Tailwind CSS -->
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="bg-white shadow-xl flex flex-col w-64 fixed md:relative h-screen z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-gray-500 text-sm text-center mt-2">Panel del Cliente</p>
            </div>
            ...
            <div class="p-4 border-t border-gray-200">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3">
                        <h3 id="userName" class="font-medium text-gray-800">Juan Pérez</h3>
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-grow p-4 md:p-6 overflow-y-auto">
                <div id="dashboardContent" class="bg-white rounded-xl shadow p-6">
                    <h3 class="text-xl font-bold text-primary mb-4">Bienvenido al Panel del Cliente</h3>
                    <p class="text-gray-700 mb-4">Gestione sus pagos y servicios de internet desde este panel.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div class="bg-primary-light p-5 rounded-lg border-l-4 border-primary">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-bold text-primary">Mis Pagos</h4>
                                    <p class="text-gray-600 text-sm">Gestione sus pagos de servicio</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-secondary-light p-5 rounded-lg border-l-4 border-secondary">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="font-bold text-secondary">Mi Perfil</h4>
    ...
    <script>
        ...
        function loadPageContent(page) {
            ...
            switch(page) {
                case 'dashboard':
                    contentHTML = `
                        <h3 class="text-2xl font-bold text-primary mb-4">Dashboard del Cliente</h3>
                        <p class="text-gray-700 mb-6">Bienvenido al panel de gestión de su servicio de internet. Aquí puede administrar sus pagos, ver el estado de su servicio y más.</p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-primary-light p-5 rounded-xl border-l-4 border-primary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-bold text-primary text-lg">Próximo Pago</h4>
                                        <p class="text-3xl font-bold mt-2 text-primary">15 Ene</p>
                                    </div>
                                    <div class="bg-primary p-4 rounded-lg">
                                        <i class="fas fa-calendar-alt text-white text-2xl"></i>
                                    </div>
                                </div>
                                <p class="text-sm text-gray-600 mt-3">Fecha de vencimiento</p>
                            </div>
                            
                            <div class="bg-secondary-light p-5 rounded-xl border-l-4 border-secondary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-bold text-secondary text-lg">Estado del Servicio</h4>
                                        <p class="text-3xl font-bold mt-2 text-secondary">Activo</p>
                                    </div>
                                    <div class="bg-secondary p-4 rounded-lg">
                                        <i class="fas fa-wifi text-white text-2xl"></i>
                                    </div>
                                </div>
                                <p class="text-sm text-gray-600 mt-3">Conectado a la red principal</p>
                            </div>
                            
                            <div class="bg-primary-light p-5 rounded-xl border-l-4 border-primary">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="font-bold text-primary text-lg">Consumo Mensual</h4>
                                ...
                                <p class="text-sm text-gray-600 mt-3">De su plan contratado</p>
                            </div>
                        </div>
                    `;
                    break;
                    ...
                    contentHTML = `
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <ul class="list-disc pl-5 text-gray-700 space-y-2">
                                <li>Contenido específico para clientes</li>
                                <li>Gestión de pagos personales</li>
                                <li>Consulta de facturas y consumos</li>
