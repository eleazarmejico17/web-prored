...
<body class="bg-background font-sans text-gray-700 antialiased overflow-hidden">
    ...
    $menu = [
        ...
        'cobranza' => [
            'icon' => 'fa-user-clock',
            'texto' => 'Cobranza y Morosidad',
            'submenu' => []
        ],
        'cargos' => [
            'icon' => 'fa-file-invoice-dollar',
            'texto' => 'Cargos Adicionales',
            'submenu' => []
        ],
        'comprobantes' => [
            'icon' => 'fa-receipt',
    ...
    if (file_exists("includes/ventas/{$pagina}.php")) {
        $rutaDashboard = "includes/ventas/{$pagina}.php";
    } else {
            ...
            <div class="p-4 border-t border-gray-100 bg-gray-50/50">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3 overflow-hidden">
                        <h3 class="font-semibold text-sm text-gray-800 truncate">María González</h3>
                        <p class="text-xs text-gray-500 truncate">Ejecutiva de Ventas</p>
                    </div>
                </div>
                        ...
                        <div class="relative">
                            ...
                            <div id="notificationsPanel"
                                ...
                                <div class="max-h-64 overflow-y-auto custom-scrollbar" id="notificationsList">
                                    <!-- Notificaciones estáticas por ahora -->
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-800 font-semibold">Venta aprobada: Cliente #9021
                                            </p>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-800">Meta mensual al 85%</p>
