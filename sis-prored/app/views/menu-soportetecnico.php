...
<body class="bg-background font-sans text-gray-700 antialiased overflow-hidden">
    ...
    // Definición centralizada del menú de soporte técnico
    $menu = [
        'home' => [
            'icon' => 'fa-home',
            'texto' => 'Home',
        ...
        'reportes' => [
            ...
            'submenu' => [
                ...
                'mapa-calor' => 'Incidencias por Zona'
            ]
        ],
        'winbox' => [
            'icon' => 'fa-box',
    ...
    if (file_exists("includes/soporte-tecnico/{$pagina}.php")) {
        $rutaDashboard = "includes/soporte-tecnico/{$pagina}.php";
    } else {
            ...
            <div class="p-4 border-t border-gray-100 bg-gray-50/50">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-3 overflow-hidden">
                        <h3 class="font-semibold text-sm text-gray-800 truncate">Roberto Díaz</h3>
                        <p class="text-xs text-gray-500 truncate">Soporte Nivel 2</p>
                    </div>
                </div>
                <button onclick="alert('Cerrando sesión de soporte...')"
                            ...
                            <div id="notificationsPanel"
                                ...
                                <div class="max-h-64 overflow-y-auto custom-scrollbar" id="notificationsList">
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-800 font-semibold">Ticket #4920: Sin conexión
                                                (Empresarial)</p>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-800 font-semibold">Ticket #4918: Lentitud zona
                                                Sur</p>
                                            <p class="text-xs text-gray-400 mt-1">Hace 20 min</p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-800">Mantenimiento OLT-04 finalizado</p>
            ...
            <main id="mainContainer" class="flex-grow p-4 md:p-6 overflow-y-auto custom-scrollbar bg-background">
                <div id="dashboardContent" class="max-w-7xl mx-auto page-enter">
                    ...
                    if (file_exists($rutaDashboard)) {
                        ...
                        echo '</div>';
                        echo '<h2 class="text-2xl font-bold text-gray-800 mb-2">Dashboard de Soporte no encontrado</h2>';
